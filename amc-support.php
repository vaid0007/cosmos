...
<head>
    ...
    <!-- Primary SEO -->
    <title>AMC & Support Services | Annual Maintenance Contracts | Cosmos Enterprises</title>
    <meta name="description" content="Professional AMC & support services for CCTV, fire fighting, access control and pest control systems. Preventive maintenance, emergency support and system audits by Cosmos Enterprises.">
    <meta name="keywords" content="AMC services, annual maintenance contract, CCTV AMC, fire system AMC, access control AMC, pest control AMC, technical support services India">
    <meta name="robots" content="index, follow">

    <!-- Canonical -->
    <link rel="canonical" href="https://www.yourwebsite.com/amc-support.php">

    <!-- Open Graph -->
    <meta property="og:title" content="AMC & Support Services | Cosmos Enterprises">
    <meta property="og:description" content="Reliable annual maintenance and technical support services for security, safety and automation systems.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://www.yourwebsite.com/amc-support.php">
    <meta property="og:image" content="https://www.yourwebsite.com/assets/images/og/amc-support.jpg">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="AMC & Support Services | Cosmos Enterprises">
    <meta name="twitter:description" content="Preventive maintenance, emergency support and AMC plans for safety systems.">
    <meta name="twitter:image" content="https://www.yourwebsite.com/assets/images/og/amc-support.jpg">
                        ...
                        <div class="featured-block col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="content">
                                    ...
                                    <h5>24/7 <br> Technical Support</h5>
                                </div>
                            </div>
                        </div>
