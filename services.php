		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="security-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-detail.html"><img src="assets/images/resource/security-4.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="hover-bg-color"></div>
							<div class="upper-box">
								<div class="icon flaticon-cctv"></div>
								<h5><a href="service-detail.html">CCTV Cameras</a></h5>
							</div>
				...
				<div class="security-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-detail.html"><img src="assets/images/resource/security-5.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="hover-bg-color"></div>
							<div class="upper-box">
								<div class="icon flaticon-lcd"></div>
								<h5><a href="service-detail.html">Theft Protection</a></h5>
							</div>
							<div class="text">Corem ipsum dolor sit amet consec exea dolore fugiatmagna exerd coas</div>
						</div>
					</div>
				...
				<div class="security-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-detail.html"><img src="assets/images/resource/security-6.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="hover-bg-color"></div>
							<div class="upper-box">
								<div class="icon flaticon-alarm-1"></div>
								<h5><a href="service-detail.html">Fire Alarm Systems</a></h5>
							</div>
							<div class="text">Corem ipsum dolor sit amet consec exea dolore fugiatmagna exerd coas</div>
						</div>
					</div>
				...
				<div class="security-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-detail.html"><img src="assets/images/resource/security-7.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="hover-bg-color"></div>
							<div class="upper-box">
								<div class="icon flaticon-keyboard"></div>
								<h5><a href="service-detail.html">Touchscreen Keypads</a></h5>
							</div>
							<div class="text">Corem ipsum dolor sit amet consec exea dolore fugiatmagna exerd coas</div>
						</div>
					</div>
				...
				<div class="security-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-detail.html"><img src="assets/images/resource/security-8.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="hover-bg-color"></div>
							<div class="upper-box">
								<div class="icon flaticon-bell"></div>
								<h5><a href="service-detail.html">Doorbell Cameras</a></h5>
							</div>
							<div class="text">Corem ipsum dolor sit amet consec exea dolore fugiatmagna exerd coas</div>
						</div>
					</div>
				...
				<div class="security-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-detail.html"><img src="assets/images/resource/security-9.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="hover-bg-color"></div>
							<div class="upper-box">
								<div class="icon flaticon-telephone-1"></div>
								<h5><a href="service-detail.html">Home Automation</a></h5>
							</div>
							<div class="text">Corem ipsum dolor sit amet consec exea dolore fugiatmagna exerd coas</div>
						</div>
					</div>
